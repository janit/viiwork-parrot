module github.com/janit/viiwork-parrot
...
// Local patch for a webseed-request/Torrent.close race that can panic the
// daemon (see third_party/anacrolix-torrent/VIIWORK-PARROT-PATCH.md). Upstream has
// no newer commit than the pinned pseudo-version as of this patch; drop this
// replace once a fix lands upstream and the pin is bumped past it.
