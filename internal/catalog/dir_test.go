...
func TestDirModelValidateRejects(t *testing.T) {
	mut := map[string]func(m []Model) []Model{
		...
		"newline":           func(m []Model) []Model { m[1].Files[0].Name = "a\nb"; return m },
		"tab":               func(m []Model) []Model { m[1].Files[0].Name = "a\tb"; return m },
		"DEL":               func(m []Model) []Model { m[1].Files[0].Name = "a\x7fb"; return m },
